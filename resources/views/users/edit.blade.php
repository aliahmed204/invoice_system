                ...
                <div class="card-body">
                    <div class="col-lg-12 margin-tb">
                        <div class="pull-right">
                            <a class="btn btn-primary btn-sm" href="{{ route('users.index') }}">Go Back</a>
                        </div>
                    </div><br>
                        ...
                        <div class="">
                            ...
                            <div class="row mg-b-20">
                                ...
                                <div class="parsley-input col-md-6 mg-t-20 mg-md-t-0" id="lnWrapper">
                                    ...
                                    <input class="form-control form-control-sm mg-b-20"
                                           data-parsley-class-handler="#lnWrapper" name="email" required="required" type="email"
                                           value="{{$user->email}}" >
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="roles_name[]"   class="form-control" multiple >
                                        @foreach($roles as $role)
                                            <option value="{{$role}}" @selected(in_array($role , $userRole)) > {{ $role }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
